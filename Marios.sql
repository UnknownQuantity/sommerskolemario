...
INSERT INTO `kunde` VALUES (1,'22755844','Jon','Nordre Frihavnsgade ',2100),(2,'31233232','Jønke','Titangade 10',2200),(3,'56656565','Fehår','Titangade 10',2200),(4,'31211221','Totenschläger','Amagerbro 23',2300),(5,'22755844','Jon','Nordre Frihavnsgade ',2100),(6,'31233232','Jønke','Titangade 10',2200),(7,'56656565','Fehår','Titangade 10',2200),(8,'31211221','Totenschläger','Amagerbro 23',2300);
...
INSERT INTO `ordre` VALUES (1,1170,0,2),(2,1140,0,3),(3,1200,0,1),(4,1170,0,2),(5,1140,0,3),(6,1200,0,1);
...
CREATE TABLE `pizza` (
  `pizza_id` int(11) NOT NULL,
  `navn` varchar(45) COLLATE utf8_danish_ci NOT NULL,
  `beskrivelse` varchar(100) CHARACTER SET utf8 COLLATE utf8_danish_ci NOT NULL,
...
INSERT INTO `pizza` VALUES (1,'Vesuvio','tomat, ost, skinke',57),(2,'Amerikaner','tomat, ost, oksefars',53),(3,'Cacciatore','tomat, ost, pepperoni',57),(4,'Carbona','tomat, ost, kødsauce, spaghetti, cocktailpølser',63),(5,'Dennis','tomat, ost, skinke, pepperoni, cocktailpølser',65),(6,'Bertil','tomat, ost, bacon',57),(7,'Silvia','tomat, ost, pepperoni, rød peber, løg, oliven',61);
...
-- Dump completed on 2018-06-28 11:18:18
